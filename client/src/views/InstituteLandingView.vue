...
import Coupon from "@/components/landing/Coupon.vue";
...
<template>
  ...
  <Modal
    v-model:isOpen="isCouponOpen"
    title="До 31 мая"
    width="500px"
  >
    <Coupon @openPolicy="isPolicyOpen = true" @submit="isNotificationOpen = true; isCouponOpen = false"/>
  </Modal>
  ...
  <Modal
    ...
    width="600px">
    <p style="font-size: 1rem; line-height: 120%; padding: 1rem">
